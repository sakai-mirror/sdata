 ...
 * @author
 */
public class ProfileSqlreader2 implements SqlReader
{
	private static final Log log = LogFactory.getLog(ProfileSqlreader2.class);
	 ...
	 */
	public ProfileSqlresult2 readSqlResultRecord(ResultSet result)
	{
		...
		try
		{
			...
			res.setUserid(result.getString("USER_ID"));
