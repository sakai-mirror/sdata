 ...
 * @author
 */
public class PresenceObserver implements Observer
{

	private static final Log log = LogFactory.getLog(PresenceObserver.class);
	...
	public PresenceObserver() {
		...
		if (autoDDL) {
			sqlService.ddl(this.getClass().getClassLoader(), "sdata_presence");
		}
