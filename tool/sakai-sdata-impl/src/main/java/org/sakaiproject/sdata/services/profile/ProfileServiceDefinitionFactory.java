 ...
 * @author
 */
public class ProfileServiceDefinitionFactory implements ServiceDefinitionFactory
{

	/**
	 */
	public ProfileServiceDefinitionFactory()
	{
	}
			...
			HttpServletResponse response) throws SDataException
	{
		...
		return new ProfileBean(userId, request, response);
	}
