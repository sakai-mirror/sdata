 ...
 * @author
 */
public class SearchCloudHandler extends JSONServiceHandler
{

	private static final long serialVersionUID = 1L;
	private EventTrackingService eventTrackingService;
	private SearchCloudObserver observer;

    public SearchCloudHandler() {
    	observer = new SearchCloudObserver();
	...
	{
		return new SearchCloudServiceDefinitionFactory();
	}
