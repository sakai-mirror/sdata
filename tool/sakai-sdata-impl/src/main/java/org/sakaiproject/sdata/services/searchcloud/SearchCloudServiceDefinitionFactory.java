 ...
 * @author
 */
public class SearchCloudServiceDefinitionFactory implements ServiceDefinitionFactory
{

	/**
	 */
	public SearchCloudServiceDefinitionFactory()
	{
	}
			...
			HttpServletResponse response) throws SDataException
	{
		...
		return new SearchCloudBean(request, response);
	}
