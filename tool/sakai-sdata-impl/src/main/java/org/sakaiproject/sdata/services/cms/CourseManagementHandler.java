...
/**
 * Handler for CourseManagement, in JSON form
 * 
 */
public class CourseManagementHandler extends JSONServiceHandler
{
	...
	{
		return new CourseManagementServiceDefinitionFactory();
	}
