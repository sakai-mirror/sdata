 ...
 * 
 */
public class HistoryServiceDefinitionFactory implements ServiceDefinitionFactory
{
	...
	public HistoryServiceDefinitionFactory()
	{
			...
			HttpServletResponse response) throws SDataException
	{
		...
		return new HistoryBean(request, response, sessionManager, userDirectoryService);
	}
