 ...
 * @author
 */
public class MessageServiceDefinitionFactory implements ServiceDefinitionFactory
{

	/**
	 */
	public MessageServiceDefinitionFactory()
	{
	}
			...
			HttpServletResponse response) throws SDataException
	{
		...
		return new MessageBean(request, response);
	}
