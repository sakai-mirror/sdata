 ...
 * @author
 */
public class ConnectionServiceDefinitionFactory implements ServiceDefinitionFactory
{

	/**
	 */
	public ConnectionServiceDefinitionFactory()
	{
	}
			...
			HttpServletResponse response) throws SDataException
	{
		...
		return new ConnectionBean(request, response);
	}
